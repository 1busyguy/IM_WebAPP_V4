...
interface CreatePartnerUserModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (userData: {
    first_name: string;
...
export const CreatePartnerUserModal: React.FC<CreatePartnerUserModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
}) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-12 gap-6 p-6">
          ...
          <div className="col-span-4 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500"
                required
              />
            </div>
          ...
          {/* Right Column - User Description and Social Media */}
          <div className="col-span-4 space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700">
                User Description
              ...
              <textarea
                ...
                maxLength={150}
                rows={4}
                className="mt-1 w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
              />
              <p className="text-xs text-gray-500 mt-1">150 characters max</p>
            </div>

            <div>
              <h4 className="text-sm font-medium text-gray-700">Social Media Accounts</h4>
