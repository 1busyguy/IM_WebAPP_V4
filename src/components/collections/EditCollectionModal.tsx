...
export function EditCollectionModal({ isOpen, onClose, collectionId, userId, availableActivations }: EditCollectionModalProps) {
      ...
      if (collection) {
        setFormData({
          ...
          external_link: {
            ...
            image_url: collection.external_link?.image_url || ''
          }
        });
      }
    }
